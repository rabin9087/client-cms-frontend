  ...
  return (
    <div className="md:flex justify-around items-start w-full p-7 shadow-lg footer gap-4">
      <div className="block justify-start w-full  items-start mt-6 ">
        ...
        <div className="md:flex md:justify-start inline-flex justify-center gap-8 p-4 pl-0">
          ...
          <div className="font-sans">
            <a href="https://www.linkedin.com/in/rabin-shah/" target="blank">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                x="0px"
                y="0px"
      ...
      <div className="block justify-start w-full items-start mt-6 ">
        ...
        <div className="inline-block gap-6 items-center">
          <div className="font-medium py-2">
            Phone:{" "}
            <a href="tel:+61481452920" className="hover:underline ">
              0481452920
            </a>
          </div>
      ...
      <div className="catelouge block justify-start  w-full mt-6  items-start ">
        <div className="font-bold">Catalogue</div>
      ...
      <div className="about block md:block gap-8 justify-start  w-full mt-6  items-start ">
        <div className="font-bold">About Cricket Gear</div>
        <div className="flex md:block justify-start  gap-4 font-medium   ">
